...
class User(Base):
    ...
    tokens_created = relationship("InviteToken", foreign_keys="InviteToken.created_by", back_populates="creator")
...
class InviteToken(Base):
    """
    Single-use invite token generated by admin.
    Consumed at registration by the first user who signs up with it.
    Tokens expire 7 days after creation if unused.
    Revoked tokens are soft-deleted to preserve the audit trail.
    """
